      ...
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-xl overflow-hidden grid md:grid-cols-2 min-h-[520px] border border-gray-100">
        ...
        <div className="p-8 sm:p-10 md:p-12 flex flex-col justify-center bg-white">
          <div className="w-full max-w-sm mx-auto">
            ...
            <div className="mb-6">
              <h3 className="text-xl font-extrabold text-[#0B1F3A] tracking-tight">Welcome Back</h3>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-9 pr-3 py-2.5 rounded-xl border text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 transition-all ${
                      errors.email
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full pl-9 pr-9 py-2.5 rounded-xl border text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 transition-all ${
                      errors.password
                        ? "border-red-500 focus:ring-red-100"
                        : "border-slate-200 focus:border-[#0B1F3A] focus:ring-slate-100"
                    }`}
              ...
              <div className="flex items-center">
                <input
                  id="remember-me"
                  type="checkbox"
                  className="h-3.5 w-3.5 text-[#0B1F3A] focus:ring-[#0B1F3A] border-slate-300 rounded cursor-pointer"
                />
                <label htmlFor="remember-me" className="ml-2 text-[11px] font-semibold text-slate-500 cursor-pointer select-none">
