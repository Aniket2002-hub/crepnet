...
export default function ContactPage() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      alert(
        `Thank you, ${fullName}! Your message has been sent successfully. We will get back to you soon.`,
      );
      setFullName("");
      setEmailAddress("");
      setPhoneNumber("");
      ...
      <section className="relative overflow-hidden bg-[#0B1F3A] min-h-[260px]">
        ...
        <div className="absolute inset-0 ">
          <img
            ...
            alt="RPEC Office Boardroom overlooking night skyline"
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-8 lg:px-12 lg:py-10 text-left">
          ...
          <div className="space-y-4 max-w-3xl">
            <h1
              ...
              className="text-white font-bold leading-[1.3] mb-3 text-[clamp(20px,2.5vw,36px)]"
            >
            ...
            <p className="mt-2 max-w-xl text-sm font-semibold leading-[1.7] text-slate-200 mb-6">
              ...
              The RPEC team is here to help.
            </p>
            <div className="mt-3.5 h-[3px] w-14 rounded-sm bg-[#c9a84c]" />
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 -mt-8 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-6">
            {/* Card 1: Our Address */}
            <div className="bg-white flex-1 border border-slate-100 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow flex items-start gap-3.5 text-left">
              ...
              <div className="space-y-1.5">
                <h3
                  style={headingFontClass}
                  className="font-bold text-[#0B1F3A] text-lg leading-none"
                >
                  Our Address
                </h3>
                <div className="h-[2.5px] w-8 bg-[#c9a84c] rounded-full" />
                <p className="text-slate-500 text-xs leading-relaxed font-medium">
                  <span className="font-bold text-[#0B1F3A] block mb-1 text-sm">
                    RPEC
                  </span>
            ...
            <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow flex items-start gap-3.5 text-left">
              ...
              <div className="space-y-1.5 w-full">
                ...
                <div>
                  <a
                    href="mailto:info@repc.in"
                    className="inline-block text-[#0B1F3A] hover:underline font-bold text-sm sm:text-base leading-none whitespace-nowrap"
                  >
                    info@repc.in
                  </a>
                </div>
          ...
          <div className="lg:col-span-7 bg-white border border-slate-100 rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col md:flex-row gap-8 items-stretch relative overflow-hidden">
            ...
            <div className="flex-1 space-y-6 text-left flex flex-col justify-between">
              <div>
                <h3
                  style={headingFontClass}
                  className="text-xl font-bold text-[#0B1F3A] tracking-tight"
                >
                  Send Us a Message
                </h3>
              ...
              >
                ...
                <div>
                  <textarea
                    ...
                    className="w-full px-3.5 py-3 bg-white border border-slate-200 rounded-xl text-sm placeholder-slate-400 focus:outline-none focus:border-slate-350 text-slate-800 resize-none flex-1 min-h-[120px]"
                  />
                </div>
            ...
            <div className="hidden md:flex md:w-5/12 items-center justify-center shrink-0 max-w-[220px] self-center">
              <svg
                viewBox="0 0 240 240"
                className="w-full h-auto text-slate-400 fill-none stroke-current stroke-[1.25]"
              >
                <circle
                  cx="160"
                  cy="110"
                ...
                />
                <path
                  d="M 35 210 A 90 90 0 0 1 205 210"
                  stroke="#cbd5e1"
                  strokeWidth="1.25"
                  strokeDasharray="4 4"
                />
                ...
                />
                <path
                  d="M185 85 a7 7 0 0 1 12 -1 a9 9 0 0 1 14 3 a7 7 0 0 1 2 10 h-28 z"
                  stroke="#e2e8f0"
                  strokeWidth="1"
                  fill="#f8fafc"
                />
                ...
                />
                <path
                  d="M 53 210 L 53 135 L 70 145 L 70 210 Z"
                  className="fill-white stroke-slate-300"
                />
                <line
                  x1="59"
                  ...
                  x2="59"
                  y2="200"
                  className="stroke-[#be7a15] stroke-[1]"
                />
                <line
                  x1="64"
                  y1="155"
                ...
                />
                <path
                  d="M 70 210 L 70 110 L 88 110 L 88 210 Z"
                  className="fill-white stroke-slate-300"
                />
                <line
                  x1="76"
                ...
                />
                <path
                  d="M 88 210 L 88 80 L 100 68 L 112 80 L 112 210 Z"
                ...
                />
                <path
                  d="M 112 210 L 112 115 L 130 115 L 130 210 Z"
                  className="fill-white stroke-slate-300"
                />
                <line
                  x1="118"
